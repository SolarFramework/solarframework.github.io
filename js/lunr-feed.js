...
index.add({
    ...
    index.add({
      title: "who",
      content: "\nTable of Contents\n\nsubmenuconfig\nWho ?\nContact Mail\n\n\n\nsubmenuconfig\n\n\n\n\nwhat\n\n\nhow\n\n\nwho\n\n\nwhen\n\n\nfor whom\n\n\nprogrammer&#8217;s guide\n\n\nlegal notice\n\n\n\n\n\n\nWho ?\n\n\nThe SolAR initiative was launched by the Institute of Research and Technology b&lt;&gt;com, and is open to any contributors or users who share the SolAR philosophy.\n\n\n\n\n\n\n\nOur Contributors\n\n\n\n\n\n\n\n\n\n\nContact Mail\n\n\nFor any requests, please contact us.\n\n\n",
      id: 15
    });
    ...
    index.add({
      title: "for whom",
      content: "\nTable of Contents\n\nsubmenuconfig\nFor whom is SolAR?\nSolAR applications\n\n\n\nsubmenuconfig\n\n\n\n\nwhat\n\n\nhow\n\n\nwho\n\n\nwhen\n\n\nfor whom\n\n\nprogrammer&#8217;s guide\n\n\nlegal notice\n\n\n\n\n\n\nFor whom is SolAR?\n\n\n\n\nFor component developers, allowing them to create specific and optimized basic vision processing elements and share it with the community, either for free or not.\n\n\nFor pose estimation developers, allowing them to create a pose estimation pipeline with the best computer vision components available.\n\n\nFor AR service developpers, allowing them to benefit from the best pose estimation pipelines in their AR applications.\n\n\n\n\n\n\nSolAR applications\n\n\nSolAR does not aim at focalizing on dedicated use cases, but rather offer a generic framework adressing any kind of applications where AR makes sense:\n\n\n\n\nHome\n\n\n\nGaming, enhanced video contents, IoT interaction interface, etc.\n\n\n\n\n\nHealth services\n\n\n\nSurgery aid, rehabilitation, training, education, etc.\n\n\n\n\n\nIndustry\n\n\n\nAssembly, quality control, maintenance, factory planning, logistics, training, monitoring, sales and marketing, etc.\n\n\n\n\n\nReal estate\n\n\n\nConsultation, design, companion on construction site, supervision, training, sales and marketing, etc.\n\n\n\n\n\nAnd much more.\n\n\n\n\n",
      id: 17
    });
    ...
    index.add({
      ...
      content: "\nTable of Contents\n\nsubmenuconfig\nThe programmer&#8217;s guide\nSolAR Overview\nSolAR Data Structures\nSolAR components interfaces\nSolAR components handling\nFrequently Asked Questions\nContact\nContact Mail\n\n\n\nsubmenuconfig\n\n\n\n\nwhat\n\n\nhow\n\n\nwho\n\n\nwhen\n\n\nfor whom\n\n\nprogrammer&#8217;s guide\n\n\nlegal notice\n\n\n\n\n\n\nThe programmer&#8217;s guide\n\n\n\n\n\nSolAR Overview\n\n\nThe SolAR framework is a solution to easily and quickly implement custom camera pose estimation pipelines based on a set of vision and mathematics components in order to make them available to AR application developers.\n\n\nThe SolAR core handles everything that will allow the implementation of a pipeline:\n\n\n\n\nSolAR Data Structures define the information that flows in the pipelines and is exchanged between components.\n\n\nSolAR Components Interfaces define a standardized interfaces for the different categories of basic processing elements required to implement camera pose estimation (i.e.: key point extractor, descriptor computation, etc.). This unified interface is required to ensure interoperability between components allowing to easily swap one with another to improve the final camera pose estimation pipeline. Please refer to the API documentation to know more about SolAR components interfaces.\n\n\nThe SolAR Pipeline Manager handles the implementation of a pipeline by loading components, connecting them, and running the pipeline.\n\n\n\n\nThe SolAR Components are implementations of basic processing elements compliant with the SolAR components interfaces. Several components can implement the same component interface. In general, these components are created by wrapping computer vision libraries that could be either open-source (OpenCV, PCL, ROS, etc.) or proprietary. Each component can define its own parameters that will be used to tune the camera pose estimation solution.\n\n\n\n\n\n\n\n\n\nComing soon: configure components on the fly, pipeline, multithread, metadata. Please refer to the roadmap for more information.\n\n\n\n\n\n\nSolAR Data Structures\n\n\nThe SolAR pipeline consists of a chain of basic processing elements arranged so that the outputs of each element are the inputs of the next one. In order to provide modularity, SolAR defines standard data structures corresponding to the information exchanged between successive components required to implement a camera pose estimation solution.\n\n\nThe following categories list the currently implemented data structures within the SolAR framework.\n\n\nImage\n\nA SolAR image is an array of pixels where each pixel is defined by a set of color components coded with a given number of bits. Each pixel can be encoded with a dedicated colorimetric space (RGB, YUV, LAB, etc.). Contrary to OpenCV, an image is not just a Matrix, but is clearly defined as an image object to ensure that a component waiting for an image as an input will not receive a random matrix such as a pose which would not make sense. Thus, an image is defined by:\n\n\n\n\nThe image size (width, height),\n\n\nthe image layout such as LAYOUT_GRB, LAYOUT_BGR, LAYOUT_GREY, LAYOUT_RGBA, LAYOUT_RGBX, LAYOUT_UNDEFINED,\n\n\nthe pixel order either INTERLEAVED or PER_CHANNEL,\n\n\nthe size of each color component, also called data type which can be either TYPE_8U, TYPE_16U, TYPE_32U, TYPE_64U,\n\n\na pointer to the raw data\n\n\n\n\nIn order to limit memory allocations and copies, which can drastically impact the efficiency of the camera pose estimation implementation, an image can point to the raw data instantiated by third party libraries such as OpenCV or OpenVX.\n\n\n\nMatrix\n\nThe matrix implementation is based on the third party open source Eigen linear algebra library. The SolAR framework redefines the following matrices:\n\n\n\n\nSolARVector4f  equates to a 4x1 matrix of floats,\n\n\nSolARVector4d  equates to a 4x1 matrix of doubles,\n\n\nSolARVector3f  equates to a 3x1 matrix of floats,\n\n\nSolARVector3d  equates to a 3x1 matrix of doubles,\n\n\nSolARTranslationVectorf equates to a 3x1 matrix of floats used to define a translation,\n\n\nSolARPoint_3Df equates to a 3x1 matrix of floats used to define a 3D point,\n\n\nSolARPoint_2Df equates to a 2x1 matrix of floats used to define a 2D point,\n\n\nSolARPoseMatrixf equates to a 4x4 matrix of floats used to define a pose,\n\n\nSolARMatrix33d equates to a 3x3 matrix of doubles,\n\n\nSolARRotationMatrixf equates to a 3x3 matrix of floats used to define a rotation,\n\n\nSolARQuaternionf equates to a Quaternion in floats used to define a rotation.\n\n\n\n\n\nPose\n\nThe pose data structure is based on a standard homogeneous 4x4 matrix defined as row major.\nEuler angle, quaternion can be directly extracted from this structure built on the third party library Eigen.\n\n\n\nMarker\n\nA SolAR Marker is a stucture describing a convex area in a SolAR Image. it allows managing different types of markers such as the fiducial one. It encodes shape and pose information as follows:\n\n\n\n\nedges: a set of point2f defining the convex area. A fiducial marker can be described with four edges, the order of pushing the point is important and impacts the structure of the marker.\n\n\ntranslation: a vector3f defining the translation transoformation of the marker according to the camera.\n\n\nrotation: a matrix33f dedfining the rotation transformation of the marker according to the camera.\n\n\n\n\nThis structure embbeds information about the marker in a minimalist way. The reason is directly linked to the desired genericity across all the existing markers in the state-of-the-art methods.\n\n\n\nFeatures\n\nThe current feature datastructure is not the final implementation we are aiming for.\nFor now, this data structure takes advantage of the cv::Features2D definition coming from openCV.\nHowever, we are currently working on an abstract API to handle multiple keypoints, features descriptors and extractors\nimplementations using tech such as CUDA and openVX while managing properly memory and avoiding useless copy.\n\n\n\n\n\nSolAR components interfaces\n\n\nSolAR components are vision or mathematics processing elements compliant with the SolAR component interface defined by the SolAR framework.\n\n\n\n\n\n\n\nAcquisition\n\nThis interface manages the capturing strategy from a given device and provides the input signal to the next processing blocs.\n\n\nImage\n\nTo manage image acquisition, ISolARCamera is dedicated to such signal. It allows grabbing current image and sets/extracts some paramaters related to the projection and acquisition\nmodels respectivly as follows:\n\n\n\n\nset/get camera acquisition paramerters: allows to get default acquisition setting parameters  (image size, frame rate..). The user can also set customized paramaters which force the camera grabbing parameters to that values.\n\n\nset/get camera projection paramerters: allows to get camera projection parameters including camera matrix and distorsion parameters (under the assumption that the camera\nis already calibrated). The user can set these parameters by performing a preliminary calibration.\n\n\n\n\n\n\nConversion\n\nThis interface manages conversion for different data structure.\n\n\nImage\n\nTo manage image conversion, ISolaARImageConvertor adresses different image conversion. It allows converting both color and type value using one unified method which, automatically,\ndetect the color and/or type layers from input and ouput respectively for the conversion.\n\n\n\n\nFiltering\n\nThis interface manages different filetring operations on different data structure.\n\n\nImage\n\nTo filter images, ISolARImageFilter is dedicated to perform various filtering operations assuming input/output consistency. That interface embbeds the following operations:\n\n\n\n\nbinarizing\n\n\nequalizing\n\n\nblurring\n\n\nerosion\n\n\ndilatation\n\n\ngradient\n\n\nlaplacian\n\n\n\n\n\nFeatures\n\nTo filter featuress, ISolARFeaturesFilter is dedicated to filter different extracted/computed features.\n\n\n\nMarkers\n\nTo filter markers, ISolARMarkerFilter is dedicated to enhance different marker filetring.\n\n\n\n\nEstimation\n\nThis interface manages different camera/object/marker pose estimation based on different methods.\n\n\nFeatures\n\nISolARKeypointDetector, ISolARDescriptorExtractor and ISolARDescriptorMatcher allow to detect geometrically relevant points in the image (SURF, SIFT..), coompute desciptors around these\npoints and finally output a set of matches. ISolARHomographyFinder performs an homography transformation estimation and extracts a final camera pose.\n\n\n\nMarker\n\nISolARMarkerFinder allows different operations performed on different marker types such as fiducial. It detect, segment and recognize the marker and estimate its pose according to the camera.\n\n\n\n\nSolAR Third Party Connector\n\nThe SolAR third party connector is a special SolAR Component use to exchange internal SolAR pose data with any third party outside of the SolAR framework. It is used to safely provide access to a SolARImage and its associated SolARPose in a thread safe race free fashion. It internally implements a mutex locked circular buffer, allowing safe producer/consumer access. It allows synchronous and asynchronous read access for the consumer.\n\n\n\n\n\n\n\nThe internal buffer size of the container is currently set at one which means only the latest image and pose are available to the consumer at any given time. In the near future, SolAR will allow users to provide initialization parameters when creating components so the users will be able to specify the size of the buffer they desire.\n\n\nProducer\n\nAny component wishing to expose its pose data to an external third party must use a Third Party Connector. It can then use the set method to set the current SolARImage and its associated SolARPose. The set method is thread safe and blocking. It will not return until the lock on the internal buffer is released by the reader.\n\n\n\nConsumer\n\nAny third party external to SolAR that needs access to internal pose data of a component must connect to its Third Party Connector. It can then use either the get method or the tryGet method to get the latest SolARImage and its associated SolARPose. The get method is thread safe and blocking. This means it will not return until there is available data to read and the lock on the internal buffer is released by the writer. The tryGet method is also thread safe but non blocking. It will return immediately after being called. It will return true if it was able to acquire the lock and read the data, or false if it was unable to obtain the lock or if there was nothing to read.\n\n\n\n\n\n\nSolAR components handling\n\n\nSolAR relies on XPCF (the Cross Platform Component Framework), a versatile framework that provides dynamic component instantiation and loading from modules. Basically, modules are libraries that gather components sharing a common purpose, framework, etc. XPCF also provides uniform component parametrization. Using XPCF, and thanks to the unified Solar interfaces,  it will be possible to build applications by picking up different components in different modules at runtime.\n\n\nFor more details, please refer to the XPCF website (coming soon).\n\n\n\n\nFrequently Asked Questions\n\n\n\n\nWhat is SolAR?\nSolAR is an open source initiative to develop a framework for pose estimation that can be used for Augmented Reality applications.\n\n\nWho initiated the SolAR project?\nThe b&lt;&gt;com Institute of Research and Technology initiated the SolAR project, after collecting the feedback of AR actors, AR end-users (industry, real-estate, medical, etc.), AR developers (essentially SMEs) and computer vision experts (Academic researchers and research engineers from companies).\n\n\nWho can contribute to the SolAR project?\nAnyone can contribute to the SolAR project. Contributors only need to be proficient in C++ and computer vision skills.\n\n\nCan I use the SolAR framework for my AR applications?\nOf course! Just be wary of the licenses of the components used by the pose estimation pipelines you choose as each component can be under its own license, independently of the encompassing SolAR Apache v2 license.\n\n\n\n\n\n\nContact\n\n\n\n\n\nContact Mail\n\n\nFor any requests, please contact us.\n\n\n",
      id: 18
    });
