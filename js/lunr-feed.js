...
index.add({
    ...
    index.add({
      title: "what",
      content: "\nTable of Contents\n\nsubmenuconfig\nWhat ?\n\nWhy SolAR ?\n\n\n\n\n\nsubmenuconfig\n\n\n\n\nwhat\n\n\nhow\n\n\nwho\n\n\nwhen\n\n\nfor whom\n\n\n\n\n\nWhat ?\n\nSolar is an Open-Source initiative to ease the developement and the maintenance of Augmented Reality applications based on State-of-the-art camara pose estimation pipelines.\n\n\nA camera pose estimation pipeline is an assembly of components that takes at one end a camera frame and that provides at the other end a camera pose.\n\n\n\n\n\n\n\nThe Solar Open-Source Initiative will provide a framework with the following features :\n\n\n\n\nA unified set of interfaces that the components present in containers must be compliant with. Each interface is also bind to an unique UID.\n\n\nA set Solar components/interfaces to interact with rendering tools such as Unreal and Unity.\n\n\nTools to create your own container, e.g. with optimised and/or new components that are not provided elsewhere.\n\n\nTools to create and add your own component to an existing container, which e.g. implements a new functionnality\n\n\nA github repository to manage the framework. It will contain codes and a Wiki. Containers will also be available there. This is also where collaborative work will take place.\n\n\n\n\nIn SolAR paradigm, components are grouped in so-called containers and containers can be mixed to build a given pipeline.\n\n\nWhy SolAR ?\n\n\nAs AR toolkits available are for common usage and pose estimation can not be tuned for your own use case, pose estimation is not always as best at it could be .\n\n\nSo we created SolAR because an opensource framework is clearly missing for pose estimation.\n\n\nSo we created SolAR to :\n\n\n\n\noffer an opensource pose estimation framework, where anyone can contribute, to take the best of the knowledges in this specific problematic.\n\n\nmake possible for vision component developers to test it in a complete pose estimation environment, as they can connect it in a end-to-end pose estimation scheme.\n\n\nmake possible for AR service developpers to have the best pose estimation for their use cases (they can choose their pose estimation solution based on SolAR).\n\n\n\n\n",
      id: 14
    });
